...
from networks.MedTrans import MedTrans
...
def net_factory(net_type="unet", in_chns=1, class_num=3, img_size=None, config=None):
    if net_type == "unet":
    ...
    elif net_type == "MedTrans":
        net = MedTrans(class_num, config).cuda()
    else:
        net = None
    return net
